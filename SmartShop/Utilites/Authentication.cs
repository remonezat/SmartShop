...
namespace SmartShop.Utilites
{
    public class Authentication
    {
        readonly string cookiename = "_bro";
        readonly int cookieKeyCount = 1;
        readonly int cookieDays = 1;

        public UserInfo CookieValues { get; set; }
        //constant crypto variables 
        private readonly static string passPhrase = "Pa7Xbnz@sE";     // can be any string
        private readonly static string saltValue = "sapkhkVAluE";     // can be any string
        ...
        public class UserInfo
        {
            ...
            public int ResturanteId { get; set; }
